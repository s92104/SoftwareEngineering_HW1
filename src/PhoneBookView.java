...
public class PhoneBookView {
	...
	public static String EDIT_RESULT_Q = 
			  "   Enter \"" + 
			  PhoneBookController.START_COMMAND + 
			  "\" to do more with the application or \"" + 
			  PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	...
	public void changeView(String newState) {
		...
		else if(newState.equals(PhoneBookModel.EDIT_RESULT_STATE))
		{
			String result = phonebookmodel.getEditResult();
			if (result == null || result.length() == 0) {
				System.out.println(SEARCH_NOT_FOUND_Q);
			}
			else {
				System.out.println(result+EDIT_RESULT_Q);
			}
		}
		//Delete
